      ...
      <div id="page" class="full-page">
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(assets/museum-kayu/buaya2.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">KISAH BUAYA BETINA MUSEUM KAYU</h1>
                     </div>
                  </div>
               </div>
            ...
            <div class="single-page-section">
               <div class="container">
                  <figure class="single-feature-img">
                     <img src="assets/museum-kayu/buaya2.jpg" alt="">
                  </figure>
                  <div class="page-content">
                     <p>Pemberitaan Monster Sangatta masih hangat ketika peristiwa berikutnya terjadi di Kecamatan Muara Badak, juga di bawah Kabupaten Kutai. Baddu, 40 tahun, yang tinggal di Tanjung Limau, diterkam buaya.
                        ...
                        Artikel kaltimkece.id, jejaring mediakaltim.com</p>
                  </div>
               </div>   
            </div>
         </main>
