...
<html lang="en">
   ...
   <style>
        ...
        @media (max-width: 768px) {
            .grid-item {
                flex: 1 0 46%; /* 2 item per baris untuk layar kecil */
            }
        }
        @media (max-width: 480px) {
            .grid-item {
                flex: 1 0 100%; /* 1 item per baris untuk layar sangat kecil */
            }
        }
      ...
      <div id="page" class="full-page">
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(assets/kayu/kayu3.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">SAMPLE HASIL OLAHAN KAYU DARI POHON KALIMANTAN</h1>
                     </div>
                  </div>
               </div>
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                                 ...
                                 <div class="grid row">
                                    ...
                                    $sql = "SELECT gambar, judul, deskripsi FROM kayu";
                                    ...
                                    if ($result->num_rows > 0) {
                                       ...
                                       while($row = $result->fetch_assoc()) {
                                             ...
                                             $gambar = 'assets/kayu/' . htmlspecialchars($row["gambar"]);
