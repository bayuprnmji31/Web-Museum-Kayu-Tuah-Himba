      ...
      <div id="page" class="full-page">
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(assets/lainnya/IMG20240523115119.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">KOLEKSI MUSEUM LAINNYA</h1>
                     </div>
                  </div>
               </div>
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                                 ...
                                 <div class="grid row">
                                    ...
                                    $sql = "SELECT gambar, judul, deskripsi FROM lainnya1";
                                    ...
                                    if ($result->num_rows > 0) {
                                       ...
                                       while($row = $result->fetch_assoc()) {
                                             ...
                                             $gambar = 'assets/lainnya/' . htmlspecialchars($row["gambar"]);
