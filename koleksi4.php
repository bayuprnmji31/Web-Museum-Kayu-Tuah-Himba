      ...
      <div id="page" class="full-page">
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(assets/rotan/galeri13.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">HASIL KERAJINAN DARI ROTAN</h1>
                     </div>
                  </div>
               </div>
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                                 ...
                                 <div class="grid row">
                                    ...
                                    $sql = "SELECT gambar, judul, deskripsi FROM rotan";
                                    ...
                                    if ($result->num_rows > 0) {
                                       ...
                                       while($row = $result->fetch_assoc()) {
                                             ...
                                             $gambar = 'assets/rotan/' . htmlspecialchars($row["gambar"]);
