      ...
      <div id="page" class="full-page">
         ...
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(assets/museum-kayu/IMG20240523122210.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">RUANGAN</h1>
                     </div>
                  </div>
               </div>
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                                 ...
                                 <div class="grid row">
                                    ...
                                    $sql = "SELECT gambar, judul, deskripsi FROM ruangan";
                                    ...
                                    if ($result->num_rows > 0) {
                                       ...
                                       while($row = $result->fetch_assoc()) {
                                             ...
                                             $gambar = 'assets/ruangan/' . htmlspecialchars($row["gambar"]);
